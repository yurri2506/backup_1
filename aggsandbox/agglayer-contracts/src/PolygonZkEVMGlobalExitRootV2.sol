...
contract PolygonZkEVMGlobalExitRootV2 is PolygonZkEVMGlobalExitRootBaseStorage, DepositContractBase, Initializable {
    ...
    function updateExitRoot(bytes32 newRoot) external {
        ...
        if (globalExitRootMap[newGlobalExitRoot] == 0) {
            ...
            _addLeaf(getLeafValue(newGlobalExitRoot, lastBlockHash, currentTimestamp));
            ...
            emit UpdateL1InfoTreeV2(currentL1InfoRoot, uint32(depositCount), lastBlockHash, currentTimestamp);
        }
    }
