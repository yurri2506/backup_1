...
impl Lmtr4Algorithm {
    ...
    pub fn rebalance_local_cc_mbmt(
        ...
        println!(
            "🔧 LMTR4: Starting Algorithm 2 rebalancing for {} blocks",
            blocks.len()
        );
        ...
        println!(
            "📊 LMTR4: Initial state - Ni = {}, b = {}, htarget = {}",
            ni, b, htarget
        );
        ...
        while ni % b != 0 {
            if let Some(last_block) = blocki.last().cloned() {
                ...
                ni += 1;
                println!(
                    "🔄 LMTR4: Fixed branch imbalance by appending last block - Ni = {}",
                    ni
                );
            } else {
                break;
        ...
        loop {
            ...
            println!(
                "📊 LMTR4: Height adjustment - Current height = {}, Target = {}",
                current_height, htarget
            );
            ...
            if current_height < htarget {
                ...
                if let Some(last_block) = blocki.last().cloned() {
                    ...
                    ni += 1;
                    println!(
                        "⬆️ LMTR4: Added block to increase height - Ni = {}, height = {}",
                        ni, current_height
                    );
                } else {
                    break;
                ...
                if ni > 1 {
                    ...
                    ni -= 1;
                    println!(
                        "⬇️ LMTR4: Removed block to decrease height - Ni = {}, height = {}",
                        ni, current_height
                    );
                } else {
                    break;
        ...
        println!(
            "✅ LMTR4: Rebalancing complete - Final Ni = {}, height = {}",
            ni, final_height
        );
    ...
    pub fn verify_rebalanced_height(
        &self,
        rebalanced_shard: &RebalancedShard,
        ...
        println!(
            "🔍 LMTR3: Height verification - Actual: {}, Expected: {}, Match: {}",
    ...
    pub fn calculate_efficiency_gain(&self, original_count: usize, rebalanced_count: usize) -> f64 {
        ...
        let efficiency_gain =
            (rebalanced_count as f64 - original_count as f64) / original_count as f64;
        println!(
            "📈 LMTR3: Efficiency gain = {:.4} ({:.2}%)",
            efficiency_gain,
    ...
    pub fn build_rebalanced_merkle_tree(
        &self,
        rebalanced_shard: &RebalancedShard,
    ...
    fn compute_block_hash(
        &self,
        block: &crate::multi_batch_header::MultiBatchHeader<
            agglayer_primitives::keccak::Keccak256Hasher,
        >,
    ) -> Result<Digest, ProofError> {
    ...
    pub fn analyze_branch_imbalance(
        &self,
        blocks: &[crate::multi_batch_header::MultiBatchHeader<
            agglayer_primitives::keccak::Keccak256Hasher,
        >],
        ...
        println!(
            "📊 LMTR3: Branch imbalance analysis - Ni = {}, b = {}, imbalance = {:.4}",
            ni, b, imbalance
        );
    ...
    pub fn analyze_height_imbalance(
        &self,
        blocks: &[crate::multi_batch_header::MultiBatchHeader<
            agglayer_primitives::keccak::Keccak256Hasher,
        >],
    ...
    fn reconstruct_block_from_bytes(
        &self,
        bytes: &[u8],
    ) -> Result<
        crate::multi_batch_header::MultiBatchHeader<agglayer_primitives::keccak::Keccak256Hasher>,
