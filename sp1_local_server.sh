...
export SP1_CIRCUITS_DIR=/home/ubuntu/thanhhuyen/sp1/target/release
export SP1_CARGO_PROVE_PATH=/home/ubuntu/.cargo/bin/cargo-prove
...
cargo-prove prove --help > /dev/null 2>&1
if [ $? -eq 0 ]; then
...
echo "Status: Active"
echo "Note: SP1 proving will use system cargo-prove"
